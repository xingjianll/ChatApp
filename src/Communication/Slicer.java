...
import Communication.DataStructures.*;
import Communication.UDPConstants;

public class Slicer extends Thread
{
	

	public LinkedList<Data> msgList;
	LinkedList<SlicePacket> slicePacketList;
	
	public Slicer(LinkedList<Data> msgList, LinkedList<SlicePacket> slicePacketList)
	{
