...
public class PacketHandler extends Thread
{
	...
	public PacketHandler(LinkedList<SlicePacket> slicePacketList2, ArrayList<SlicePacket> resendPacketList)
	{
		this.slicePacketList = slicePacketList2;
	}
				...
				synchronized (slicePacketList)
				{
					for (int i=0;i<slicePacketList.size();i++)
					{
						...
						try 
						{
							...
							ComManager.socket.send(slicePacket.packet);
